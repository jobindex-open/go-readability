...
```
go get -u -v github.com/jobindex-open/go-readability
```
...
```
go install github.com/jobindex-open/go-readability/cmd/go-readability@latest
```
...
[go-ref]: https://pkg.go.dev/github.com/jobindex-open/go-readability
